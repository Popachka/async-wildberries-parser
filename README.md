...
```bash
git clone https://github.com/Popachka/async-wildberries-parser.git
cd async-wildberries-parser
```
...
4. Улучшить README
5. Разобратсья с headless режимом, чтобы браузер не открывался. Перейти с playwright на selenium undetected.
